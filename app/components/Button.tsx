...
export const Button: React.FC<ButtonProps> = ({
  ...
  const sizeClass = {
    ...
    lg: "px-[20px] sm:px-[34px] sm:h-[50px] text-xs sm:text-base",
  };
  ...
  return (
    <Tag
      ...
      className={clsx(
        className,
        "rounded-[10px] sm:rounded-[10px] justify-center font-medium sm:font-semibold whitespace-nowrap w-fit focus:outline-blue-state disabled:cursor-not-allowed gap-2 disabled:opacity-70 cursor-pointer flex items-center transition-colors duration-100 ",
        ...
        (variant === "close" || variant === "back") &&
          "text-white bg-white/10 border border-black overflow-hidden rounded-full",
